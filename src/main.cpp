...
***********************************************************************/
#include <WiFi.h>        // 本程序使用 ESP8266WiFi库
#include <WiFiMulti.h>   //  ESP8266WiFiMulti库
#include <WebServer.h>   //  ESP8266WebServer库
 
WiFiMulti wifiMulti;     // 建立ESP8266WiFiMulti对象,对象名称是'wifiMulti'
 
WebServer esp8266_server(80);// 建立ESP8266WebServer对象，对象名称为esp8266_server
